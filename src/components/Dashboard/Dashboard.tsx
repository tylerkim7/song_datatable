        ...
        <Box sx={{ display: 'flex', color: 'primary'}}>
            ...
            >
                <Toolbar sx={myStyles.toolbar}>
                    ...
                    <Button sx={ myStyles.toolbar_button } onClick={handleDialogClickOpen}>Create New Song</Button>
                    <Dialog open={dialogOpen} onClose={handleDialogClickClose} aria-labelledby='form-dialog-title'>
                        <DialogTitle id="form-dialog-title">Add New Song</DialogTitle>
                        <DialogContent>
                            <DialogContentText>Add a New Song</DialogContentText>
                            <SongForm />
                        </DialogContent>
                        <DialogActions>
                            <Button onClick = {handleDialogClickClose} variant="contained" color = "error">Cancel</Button>
                        </DialogActions>
                    </Dialog>
                </Toolbar>
            </AppBar>
